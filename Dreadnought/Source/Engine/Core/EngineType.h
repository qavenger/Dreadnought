...
enum class EKeyCode : uint8
{
	...
	KeyBoardA = 0x41,
	KeyBoardB, KeyBoardC, KeyBoardD, KeyBoardE, KeyBoardF, KeyBoardG, KeyBoardH, KeyBoardI, 
	KeyBoardJ, KeyBoardK, KeyBoardL, KeyBoardM, KeyBoardN, KeyBoardO, KeyBoardP, KeyBoardQ, 
	KeyBoardR, KeyBoardS, KeyBoardT, KeyBoardU, KeyBoardV, KeyBoardW, KeyBoardX, KeyBoardY, KeyBoardZ,
	LWin, RWin, App,
	Sleep = 0x5F,
